        ...
        {positions.length > 0 ? (
          <div className="space-y-8">
            {positions.map((pos, idx) => (
              <div key={idx} className="border-b border-ink pb-8 last:border-0">
                ...
                {/* Status */}
                <div className="mt-6">
                  <span className={`inline-block px-4 py-2 font-mono text-xs uppercase tracking-wider ${
                    pos.trailing_active 
                      ? 'bg-brand text-paper' 
                      : 'border-sharp text-ink'
                  }`}>
